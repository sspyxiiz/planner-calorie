...
const MealPlanner = () => {
  ...
  const exportToTxt = (plan) => {
    const lines = [
      ...
      plan.title,
      plan.notes,
      `КБЖВ (на 100 г): Калорії: ${plan.total_calories.toFixed(1)}, Білки: ${plan.total_protein.toFixed(1)}г, Жири: ${plan.total_fat.toFixed(1)}г, Вуглеводи: ${plan.total_carbs.toFixed(1)}г`,
    ];
